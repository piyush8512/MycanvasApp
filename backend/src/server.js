...
// // 5. Delete Test User
// app.delete("/api/test-delete-user/:clerkId", async (req, res) => {
//   try {
...
// // ============================================
// // YOUR ORIGINAL ROUTE (Modified for Testing)
// // ============================================

// app.get("/api/me", async (req, res) => {
//   try {
//     // For testing: Get clerkId from query parameter or header
//     const clerkId = req.query.clerkId || req.headers['x-clerk-id'];
    
//     if (!clerkId) {
//       return res.status(400).json({ 
//         success: false,
//         message: "clerkId is required. Pass as ?clerkId=xxx or x-clerk-id header" 
//       });
//     }
...
//   console.log(`   2. GET  http://localhost:${PORT}/api/test-connection`);
//   console.log(`   3. POST http://localhost:${PORT}/api/test-create-user`);
//   console.log(`   4. GET  http://localhost:${PORT}/api/test-get-users`);
//   console.log(`   5. GET  http://localhost:${PORT}/api/me?clerkId=user_123`);
//   console.log(`   6. DEL  http://localhost:${PORT}/api/test-delete-user/user_123\n`);
// });
